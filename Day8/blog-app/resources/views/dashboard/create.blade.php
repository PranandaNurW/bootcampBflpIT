            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="p-5">
                        ...
                        <!-- forms -->
                        <form method="POST" action="{{ route('dashboard.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <input type="text" name="title" class="form-control form-control-user @error('title') is-invalid @enderror"
                                    placeholder="Enter title..." value="{{ old('title') }}" id="title" required>
                                @error('title')
                            ...
                            <div class="form-group">
                                <input type="text" name="slug" class="form-control form-control-user @error('slug') is-invalid @enderror"
                                    placeholder="Enter slug..." value="{{ old('slug') }}" id="slug" readonly required>
                                @error('slug')
                                <div class="ml-3 invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                placeholder="Enter body..." value="{{ old('body') }}" id="body" required>
                            ...
                            <button class="btn btn-primary btn-user" type="submit">Add Post</button>
                        </form>
                        <!-- forms -->
                    </div>
                </div>
